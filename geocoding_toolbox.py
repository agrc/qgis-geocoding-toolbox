...
class AGRCGeocodingToolbox:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'AGRCGeocodingToolbox_{}.qm'.format(locale))
        ...
        self.toolbar = self.iface.addToolBar(u'AGRCGeocodingToolbox')
        self.toolbar.setObjectName(u'AGRCGeocodingToolbox')
    ...
    def add_action(
        ...
        self.dlg = AGRCGeocodingToolboxDialog()
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/AGRCGeocodingToolbox/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'AGRC Geocoding Toolbox'),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&AGRC Geocoding Toolbox'),
                action)
